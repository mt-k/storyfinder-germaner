    ...
    extends JCasAnnotator_ImplBase
{
        ...
        throws IOException
    {
    	...
    	/*if(NERReader.cachedReaders.containsKey(aName))
    		return NERReader.cachedReaders.get(aName);*/
        ...
        while (entry != null) {
            if (entry.toString().equals(aName)) {
            	//NERReader.cachedReaders.put(aName, new BufferedReader(new InputStreamReader(zis)));
               // return NERReader.cachedReaders.get(aName);
